        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HatchColor = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlotRequests_PlotId_Status",
                table: "PlotRequests",
                columns: new[] { "PlotId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlotStatusHistory_PlotId_ChangedAtUtc",
                table: "PlotStatusHistory",
                columns: new[] { "PlotId", "ChangedAtUtc" });
