...
namespace AssetRequestApi.Data;
...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<ApplicationUser>(entity =>
        {
            ...
            entity.Property(user => user.RoleFlag).IsRequired().HasMaxLength(50);
        });
        ...
        builder.Entity<PlotRequest>(entity =>
        {
            ...
            entity.Property(request => request.RequestType).HasConversion<string>().IsRequired().HasMaxLength(50);
            entity.Property(request => request.Status).HasConversion<string>().IsRequired().HasMaxLength(50);
            ...
            entity.HasOne(request => request.DecisionByUser)
                .WithMany()
                .HasForeignKey(request => request.DecisionByUserId)
                .OnDelete(DeleteBehavior.Restrict);
        });
        ...
        builder.Entity<PlotTenantBlock>(entity =>
        {
            ...
            entity.HasOne(block => block.BlockedByUser)
                .WithMany()
                .HasForeignKey(block => block.BlockedByUserId)
                .OnDelete(DeleteBehavior.Restrict);
        });
        ...
        builder.Entity<PlotStatusHistory>(entity =>
        {
            ...
            entity.Property(history => history.FromStatus).HasConversion<string>().IsRequired().HasMaxLength(50);
            entity.Property(history => history.ToStatus).HasConversion<string>().IsRequired().HasMaxLength(50);
            ...
            entity.HasOne(history => history.ActorUser)
                .WithMany()
